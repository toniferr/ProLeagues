...
public class Resultados extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Match match = db.getPartidos(nameLeague, 1);*/
        ...
        local1j1.setText(matchj1.getLocalTeam());
        visitante1j1.setText(matchj1.getVisitTeam());
        gollocal1j1.setText(matchj1.getLocalGoals());
        golvisitante1j1.setText(matchj1.getVisitGoals());
